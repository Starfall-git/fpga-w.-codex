...
# set_clock_latency -source -setup <pll_clk_latency_clk_sys_max + 1.827> [get_ports {clk_cam_feedback}]
# set_clock_latency -source -hold <pll_clk_latency_clk_sys_min + 1.183> [get_ports {clk_cam_feedback}]
# set_clock_latency -source -setup <pll_clk_latency_clk_sys_max + 1.827> [get_ports {clk_cam_xclk}]
# set_clock_latency -source -hold <pll_clk_latency_clk_sys_min + 1.183> [get_ports {clk_cam_xclk}]
