...
module video_sobel #(
    ...
    /* V0.8 / 38: binary polarity is a port again; preserve NMS gray diagnostic
       through a separate parameter instead of overloading polarity=0. */
    ...
    input wire clk,
    input wire rst_n,
    input wire BINARY_OUTPUT, /* V0.8 / 38: 1 normal, 0 invert. */
    ...
    always @(posedge clk or negedge rst_n) begin
        ...
        if (!rst_n) begin
            ...
            begin
                ...
                if (!GRAYSCALE_OUTPUT) begin

                    rgb_o <=
                        (final_edge == BINARY_OUTPUT)
                        ? 24'hffffff
                        : 24'h000000;
                ...
                /* V0.8 / 38: invert invalid active borders too, but never blanking. */
                rgb_o <= (edge_de && !GRAYSCALE_OUTPUT && !BINARY_OUTPUT)
