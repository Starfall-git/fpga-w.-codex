...
# V0.7 / 31: 27MHz XCLK replaces16MHz.
create_clock -period 37.0370 clk_cam_xclk
...
# V0.7 / 31: sensor PLL: 27*44/(2*1*8)=74.25MHz, capture rising (3028=0010).
create_clock -period 13.4680 [get_ports {cmos_pclk}]
