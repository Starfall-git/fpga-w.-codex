...
module median_modes_tb;
  ...
  wire [3:0] h,v,d;
  always #5 clk=~clk;
  video_processing #(.IMAGE_WIDTH(16)) raw_dut
  ...
  video_processing #(.IMAGE_WIDTH(16)) med_dut
  ...
  video_processing #(.IMAGE_WIDTH(16)) edge_dut
  ...
  video_processing #(.IMAGE_WIDTH(16)) both_dut
